...
<template>
  <div class="card flex flex-col justify-content-center h-full">
    <Menu :model="items" class="flex-auto w-full md:w-15rem">
      <template #start>
        <span class="flex-none inline-flex align-items-center gap-1 px-2 py-2">
