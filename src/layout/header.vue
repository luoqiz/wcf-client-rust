...
<template>
  <div class="flex flex-row mr-16px">
    <span class="flex-none w-200px inline-flex align-items-center gap-1 px-2 py-2">
      ...
      <span class="font-medium text-xl font-semibold color-black">WCF<span class="text-primary">client</span></span>
    </span>
    <div class="flex-auto">
      <Service />
    </div>
